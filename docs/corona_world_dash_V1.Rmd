...
ggpath  <- "C:/Users/leandro/Documents/GitHub/corona_dash/"
Here    <- Sys.Date()
HereUSA <- Here - 1
HereBR  <- Here - 1
...
plots <- 
lapply(colnames(dh)[2:22], function(x){ 
                           expr   <- paste0("~", "`", x, "`")
                           mexpr  <- paste0("~", "`", "M", x, "`")
                           legm   <- paste0("Moving average of ", x)
                          t <- dh[nrow(dh),paste0("M",x)]
                          tt <- WorldCases[x,ncol(WorldCases)]
                           a <- list(
                                      text = paste0(x," - Total Cases:",tt," - MA7D:", round(t, 0)),
                                      font = f2,
                                      xref = "paper",
                                      yref = "paper",
                                      yanchor = "bottom",
                           ...
                           plot_ly(dh, x = ~Dates) %>% 
                             add_trace(y = as.formula(expr),  type = 'bar', color = I("darkorange2")) %>% 
...
lapply(colnames(dh)[2:22], function(x){ 
                           ...
                           a <- list(
                                      text = paste0(x," - Total Deaths:",tt," - MA7D:",round(t,0)),
                                      font = f2,
                                      xref = "paper",
                                      yref = "paper",
                                      yanchor = "bottom",
...
Hospitalized Currently {data-navmenu='US'} 
==========================================================================
...
lapply(colnames(dh)[2:58], function(x){ 
                          ...
                          a <- list(
                                      text = paste0(x," - Hospitalized:",tt," - MA7D:",round(t,0)),
                                      font = f2,
                                      xref = "paper",
                                      yref = "paper",
                                      yanchor = "bottom",
...
cbind(dz, dw) %>% 
  as_tibble %>% 
  filter(Dates >= as.Date("2020-04-20"))
...
Google - Countries {data-navmenu='Mobility'}
====================================================================
...
plot <-plot_ly(workplace_com_mm7d, x = ~date) %>% 
                             add_trace(y = ~BR, name="BR", type = 'scatter', mode= 'lines', line = list(color = 'rgb(241, 196, 15)', width = 2))%>% 
                             add_trace(y = ~US, name="US",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(196, 57, 43)', width = 2)) %>%
                             add_trace(y = ~DE, name="GE",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(0, 0, 0)', width = 2))%>%
                              add_trace(y = ~FR, name="FR",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(29, 105, 239)', width = 2))%>%
                              add_trace(y = ~ES, name="SP",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(156, 100, 12)', width = 2))%>%
                              add_trace(y = ~IT, name="IT",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(42, 252, 0)', width = 2))%>%
                              add_trace(y = ~GB, name="UK",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(118, 68, 138)', width = 2))%>%
                              add_trace(y = ~AU, name="AU",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(241, 14, 245)', width = 2))%>%
                              add_trace(y = ~NO, name="NO",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(81, 90, 90)', width = 2))                              
workplace <- plot %>% layout(title = "Workplace")
######

# residential

plot <-plot_ly(residential_com_mm7d, x = ~date) %>% 
                             add_trace(y = ~BR, name="BR", type = 'scatter', mode= 'lines', line = list(color = 'rgb(241, 196, 15)', width = 2))%>% 
                             add_trace(y = ~US, name="US",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(196, 57, 43)', width = 2)) %>%
                             add_trace(y = ~DE, name="GE",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(0, 0, 0)', width = 2))%>%
                              add_trace(y = ~FR, name="FR",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(29, 105, 239)', width = 2))%>%
                              ...
                              add_trace(y = ~AU, name="AU",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(241, 14, 245)', width = 2))%>%
                              add_trace(y = ~NO, name="NO",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(81, 90, 90)', width = 2))                              
residential <- plot %>% layout(title = "Residential")
...
plot <-plot_ly(retail_com_mm7d, x = ~date) %>% 
                             add_trace(y = ~BR, name="BR", type = 'scatter', mode= 'lines', line = list(color = 'rgb(241, 196, 15)', width = 2))%>% 
                             add_trace(y = ~US, name="US",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(196, 57, 43)', width = 2)) %>%
                             add_trace(y = ~DE, name="GE",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(0, 0, 0)', width = 2))%>%
                              add_trace(y = ~FR, name="FR",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(29, 105, 239)', width = 2))%>%
                              ...
                              add_trace(y = ~AU, name="AU",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(241, 14, 245)', width = 2))%>%
                              add_trace(y = ~NO, name="NO",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(81, 90, 90)', width = 2))                              
retail <- plot %>% layout(title = "Retail and Recreation")
...
plot <-plot_ly(grocery_com_mm7d, x = ~date) %>% 
                             add_trace(y = ~BR, name="BR", type = 'scatter', mode= 'lines', line = list(color = 'rgb(241, 196, 15)', width = 2))%>% 
                             add_trace(y = ~US, name="US",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(196, 57, 43)', width = 2)) %>%
                             add_trace(y = ~DE, name="GE",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(0, 0, 0)', width = 2))%>%
                              add_trace(y = ~FR, name="FR",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(29, 105, 239)', width = 2))%>%
                              ...
                              add_trace(y = ~AU, name="AU",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(241, 14, 245)', width = 2))%>%
                              add_trace(y = ~NO, name="NO",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(81, 90, 90)', width = 2))                              
grocery <- plot %>% layout(title = "Grocery and Pharmacy")
...
plot <-plot_ly(transit_com_mm7d, x = ~date) %>% 
                             add_trace(y = ~BR, name="BR", type = 'scatter', mode= 'lines', line = list(color = 'rgb(241, 196, 15)', width = 2))%>% 
                             add_trace(y = ~US, name="US",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(196, 57, 43)', width = 2)) %>%
                             add_trace(y = ~DE, name="GE",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(0, 0, 0)', width = 2))%>%
                              add_trace(y = ~FR, name="FR",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(29, 105, 239)', width = 2))%>%
                              ...
                              add_trace(y = ~AU, name="AU",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(241, 14, 245)', width = 2))%>%
                              add_trace(y = ~NO, name="NO",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(81, 90, 90)', width = 2))                              
transit <- plot %>% layout(title = "Transit Stations")
...
plot <-plot_ly(parks_com_mm7d, x = ~date) %>% 
                             add_trace(y = ~BR, name="BR", type = 'scatter', mode= 'lines', line = list(color = 'rgb(241, 196, 15)', width = 2))%>% 
                             add_trace(y = ~US, name="US",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(196, 57, 43)', width = 2)) %>%
                             add_trace(y = ~DE, name="GE",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(0, 0, 0)', width = 2))%>%
                              add_trace(y = ~FR, name="FR",  type = 'scatter', mode= 'lines', line = list(color = 'rgb(29, 105, 239)', width = 2))%>%
