...
)) %>%  DT::formatStyle(columns = 0:N, fontSize = '14pt')
```
...
ld    <- lapply(countries, function(x) as.vector(coredata(xts(t(porce_c), dates)[paste0(lockdown[x], '::'), x])))
