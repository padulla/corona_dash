...
plots$plotly
ggsave(paste0(ggpath, "EuropeDeaths.png"))
```
...
plot$plotly
ggsave(paste0(ggpath, "USACases.png"))
```
...
plot <- plotThis(UsCases, states, abr, ytitle = "Confirmed Cases", xtitle = "Days from 100 Cases")
plot$plotly
ggsave(paste0(ggpath, "USADeaths.png"))
```
...
plot$plotly
ggsave(paste0(ggpath, "BRCases.png"))
...
plot$plotly
ggsave(paste0(ggpath, "BRDeaths.png"))
...
Deaths Graphs {data-navmenu='Brasil'} 
==========================================================================
...
ggsave(paste0(ggpath,"CasesExp.png"))
```
...
plot$ggplot + 
  ...
  geom_line(d0f, mapping = aes(y = V3), linetype = 'dashed', color = "#CD0C0E") +
  annotate('text', x = 55, y = d0f[n,3,drop=T] + 0.1e5, label = "Doubles every 7 days", color = "#CD0C0E") 
ggsave(paste0(ggpath,"DeathsExp.png"))
```
